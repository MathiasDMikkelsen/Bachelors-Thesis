...
# project setup: ensure solver on path
...
# ces exponent and baseline durables in the inner solver
r  = -1.0
d0 = 0.5

# range of environmental tax to sweep
tau_z_values = np.linspace(1.0, 20.0, 50)

# storage for original policy
t_c_orig      = []
t_d_orig      = []
z_c_orig      = []
z_d_orig      = []
