...
import os
import b_outer_solver # Imports the outer solver with maximize_welfare(G, xi)
import a_inner_solver as solver # Import inner solver directly too
# *** Removed theta from import, defined locally below ***
from a_inner_solver import n, phi, t as T # Import necessary params from inner_solver
...
for xi_val in xi_values:
    ...
    try:
        ...
        opt_tau_w, opt_tau_z, max_welfare_val = b_outer_solver.maximize_welfare(G_value, xi_val)
