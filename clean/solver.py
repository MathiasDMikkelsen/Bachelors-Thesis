...
def solve(tau_w, tau_z, l_vec, G, n=5):
    ...
    return utilities, aggregate_polluting, sol.success, c, d, ell, w, p_d, tax_rev
# end solve system
...
G = 1.0
tau_z = 3.0
utilities, aggregate_polluting, first_converged, c, d, ell, w, p_d, tax_rev = solve(tau_w_arr, tau_z, l_arr, G, n=n)
