...
if converged:
    ...
    # phi, tau_w, t are parameters defined earlier

    # Calculate labor supply time for each household type
    labor_supply_time = t - l_agents

    # Calculate Net Labor Income for each household type
    # Income = productivity * wage * (1 - tax_rate) * labor_time
    # Note: phi here acts as productivity scaler for wage earning
    net_labor_income = phi * w * (1 - tau_w) * labor_supply_time
    ...
    # If the solver did not converge, print a message
    print("\n" + "="*30)
    print("      Income Analysis")
    print("="*30)
