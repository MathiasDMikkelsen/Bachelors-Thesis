...
from inner_solver import n, phi, t as T # Import n, phi, T from inner_solver
# --- End Imports ---
...
for xi_val in xi_values:
    ...
    # --- Run for G = 5.0 ---
    try:
        opt_tau_w, opt_tau_z, _ = outer_solver.maximize_welfare(G_value_base, xi_val)
    ...
    # --- Run for G = 0.0 ---
    try:
        opt_tau_w, opt_tau_z, _ = outer_solver.maximize_welfare(G_value_zero, xi_val)
        if opt_tau_w is not None and opt_tau_z is not None:
