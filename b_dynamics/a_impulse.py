...
axs[0,0].plot(tau_z_values, t_c_orig, color="blue", label="orig")
axs[0,0].plot(tau_z_values, t_c_new, color="blue", linestyle="--", label="new")
axs[0,0].set_xlabel(r'$\tau_z$', fontsize=12)
axs[0,0].set_ylabel(r'$t_c$', fontsize=12, rotation=90)
axs[0,0].legend(fontsize=10)

# Subplot (0,1): t_d vs. tau_z
axs[0,1].plot(tau_z_values, t_d_orig, color="orange", label="orig")
axs[0,1].plot(tau_z_values, t_d_new, color="orange", linestyle="--", label="new")
axs[0,1].set_xlabel(r'$\tau_z$', fontsize=12)
axs[0,1].set_ylabel(r'$t_d$', fontsize=12, rotation=90)
axs[0,1].legend(fontsize=10)

# Subplot (0,2): z_c vs. tau_z
axs[0,2].plot(tau_z_values, z_c_orig, color="green", label="orig")
axs[0,2].plot(tau_z_values, z_c_new, color="green", linestyle="--", label="new")
...
axs[1,0].plot(tau_z_values, z_d_orig, color="red", label="orig")
axs[1,0].plot(tau_z_values, z_d_new, color="red", linestyle="--", label="new")
axs[1,0].set_xlabel(r'$\tau_z$', fontsize=12)
axs[1,0].set_ylabel(r'$z_d$', fontsize=12, rotation=90)
axs[1,0].legend(fontsize=10)

# Subplot (1,1): p_d vs. tau_z
axs[1,1].plot(tau_z_values, p_d_orig, color="purple", label="orig")
axs[1,1].plot(tau_z_values, p_d_new, color="purple", linestyle="--", label="new")
axs[1,1].set_xlabel(r'$\tau_z$', fontsize=12)
axs[1,1].set_ylabel(r'$p_d$', fontsize=12, rotation=90)
axs[1,1].legend(fontsize=10)

# Subplot (1,2): w vs. tau_z
axs[1,2].plot(tau_z_values, w_orig, color="brown", label="orig")
axs[1,2].plot(tau_z_values, w_new, color="brown", linestyle="--", label="new")
...
axs[2,0].plot(tau_z_values, total_leisure_orig, 'b-', linewidth=2, label="orig")
axs[2,0].plot(tau_z_values, total_leisure_new, 'b--', linewidth=2, label="new")
...
axs[2,1].plot(tau_z_values, total_consumption_orig, 'r-', linewidth=2, label="orig")
axs[2,1].plot(tau_z_values, total_consumption_new, 'r--', linewidth=2, label="new")
...
axs[2,2].plot(tau_z_values, total_demand_orig, 'g-', linewidth=2, label="orig")
axs[2,2].plot(tau_z_values, total_demand_new, 'g--', linewidth=2, label="new")
